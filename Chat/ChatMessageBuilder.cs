...
namespace EnhancedStreamChat.Chat
{
    public class ChatMessageBuilder
    {
        ...
        public static Task<string> BuildMessage(IChatMessage msg, EnhancedFontInfo font, bool isInGame = false) => Task.Run(() =>
                                                                                                                             {
                                                                                                                                 try {
                                                                                                                                     ...
                                                                                                                                     if (msg.Emotes.Length == 0)
                                                                                                                                     {
                                                                                                                                         ...
                                                                                                                                         badges = new ConcurrentStack<EnhancedImageInfo>();
                                                                                                                                         foreach (var badge in msg.Sender.Badges)
                                                                                                                                         {
